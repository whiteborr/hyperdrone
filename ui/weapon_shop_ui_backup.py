...
class WeaponShopUI:
    ...
    def draw(self, screen):
        ...
        font_title = Font("assets/fonts/neuropol.otf", 32)
        # Shadow
    ...
    def _draw_weapon_page(self, screen, shop_x, shop_y, shop_width, shop_height):
        ...
        if not self.available_weapons:
            font_ui = Font("assets/fonts/neuropol.otf", 24)
        ...
        # Page indicator
        font_small = Font("assets/fonts/neuropol.otf", 18)
        ...
        font_title = Font("assets/fonts/neuropol.otf", 36)
        ...
        font_sub = Font("assets/fonts/neuropol.otf", 24)
        ...
        font_stats = Font("assets/fonts/neuropol.otf", 20)
        stats_y = shop_y + 220
    ...
    def _draw_confirmation(self, screen, shop_x, shop_y, shop_width, shop_height):
        ...
        font_ui = Font("assets/fonts/neuropol.otf", 20)
    ...
    def _draw_inventory_panel(self, screen, inv_x, inv_y, inv_width, inv_height):
        ...
        font_title = Font("assets/fonts/neuropol.otf", 24)
        font_ui = Font("assets/fonts/neuropol.otf", 18)
