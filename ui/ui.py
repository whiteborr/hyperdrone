...
from game_settings import (
    # Directly imported constants from the original ui.py for frequent use / readability
...
class UIManager: #
    ...
    def draw_main_menu(self): #
        ...
        if self.ui_assets["menu_background"]: #
            try: #
                ...
                self.screen.fill(BLACK) #
        # If no background, stars from draw_current_scene_ui will be visible
        ...
        if get_game_setting("SETTINGS_MODIFIED"): # Using imported get_game_setting
    ...
    def draw_settings_menu(self): #
        ...
        for i_display, list_idx in enumerate(range(view_start_index, view_end_index)): #
            ...
            if item["type"] != "action": #
                current_value = get_game_setting(item["key"]) # Using imported function
                display_value = "" #
                ...
                # DEFAULT_SETTINGS is imported from game_settings
    ...
    def draw_game_over_overlay(self): #
        ...
        is_new_high = can_submit_score and leaderboard.is_high_score(self.game_controller.score, self.game_controller.level) # Using imported leaderboard module
    ...
    def draw_leaderboard_overlay(self): #
        ...
        if not scores_to_display: #
            ...
            for i, entry in enumerate(scores_to_display): #
                if i >= get_game_setting("LEADERBOARD_MAX_ENTRIES"): break # Using imported get_game_setting
