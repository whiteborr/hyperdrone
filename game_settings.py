...
# ==========================
LIGHTNING_COLOR = (0, 220, 220)  # Bright Cyan
LIGHTNING_DAMAGE = 15
LIGHTNING_LIFETIME = 60  # Increased lifetime for visual zap effect (frames)
LIGHTNING_COOLDOWN = 750
LIGHTNING_ZAP_RANGE = TILE_SIZE * 8 # How far the lightning can "reach" an enemy
...
try:
    ...
    print("Warning (game_settings.py): Could not import Phantom cloak duration/cooldown from drone_configs. Using fallback values for DEFAULT_SETTINGS.")
...
DEFAULT_SETTINGS = {
    ...
    "PLAYER_SPEED": PLAYER_SPEED, "INITIAL_WEAPON_MODE": INITIAL_WEAPON_MODE,
    "PLAYER_BULLET_SPEED": PLAYER_BULLET_SPEED, "PLAYER_BULLET_LIFETIME": PLAYER_BULLET_LIFETIME,
    ...
    "MISSILE_SPEED": PLAYER_BULLET_SPEED * 0.8,
    "MISSILE_LIFETIME": PLAYER_BULLET_LIFETIME * 8,
    "MISSILE_COOLDOWN": MISSILE_COOLDOWN, "MISSILE_DAMAGE": MISSILE_DAMAGE,
    "ENEMY_SPEED": ENEMY_SPEED, "ENEMY_HEALTH": ENEMY_HEALTH,
...
LIGHTNING_LIFETIME = get_game_setting("LIGHTNING_LIFETIME") # Ensure this is updated globally too
