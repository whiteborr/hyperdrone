...
from game_settings import (
    ...
    # These were directly used in the original drone_configs.py
...
DRONE_DATA = {
    ...
    ARCHITECT_REWARD_BLUEPRINT_ID: { # ID should match constant from game_settings
        "name": "Architect-X", #
...
DRONE_DISPLAY_ORDER = [
    ...
    "OMEGA-9",
    "PHANTOM",
    ARCHITECT_REWARD_BLUEPRINT_ID # Use the constant here too for consistency
] #

# These were originally defined in drone_configs.py. If they are meant to be dynamic game settings,
# they should primarily live in game_settings.py and be accessed via gs.get_game_setting().
# For now, keeping them here as per original structure, but consider centralizing if they need UI config.
...
# Sanity checks (remain important)
