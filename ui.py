...
class UIManager:
    ...
    def _load_ui_assets(self):
        ...
        try:
            ...
            else: # Fallback for empty ring icon
        ...
        if os.path.exists(menu_bg_path):
            try:
                ...
                self.ui_assets["menu_background"] = None # Fallback to no background image
        else:
    ...
    def draw_drone_select_menu(self):
        ...
        drone_options_ids = getattr(self.game_controller, 'drone_select_options', []) 
